...
SRC_URI="
	amd64? ( http://www.arduino.cc/download.php?f=/arduino-1.8.14-linux64.tar.xz -> arduino-bin_amd64-1.8.14.tar.xz )

	x86? ( http://www.arduino.cc/download.php?f=/arduino-1.8.14-linux32.tar.xz -> arduino-bin_i386-1.8.14.tar.xz )
"
