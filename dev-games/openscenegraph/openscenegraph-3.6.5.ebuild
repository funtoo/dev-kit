...
SRC_URI="https://github.com/openscenegraph/OpenSceneGraph/tarball/a827840baf0786d72e11ac16d5338a4ee25779db -> OpenSceneGraph-3.6.5-a827840.tar.gz"
...
post_src_unpack() {
	if [ ! -d "${S}" ]; then
		mv openscenegraph-OpenSceneGraph-* "${S}" || die
	fi
}
