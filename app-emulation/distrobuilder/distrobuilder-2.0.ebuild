...
EGO_SUM=(
	...
	"github.com/!ada!logics/go-fuzz-headers v0.0.0-20210929163055-e81b3f25be97"
	"github.com/!ada!logics/go-fuzz-headers v0.0.0-20210929163055-e81b3f25be97/go.mod"
	...
	"github.com/canonical/candid v1.10.2/go.mod"
	"github.com/canonical/go-dqlite v1.9.0/go.mod"
	...
	"github.com/coreos/go-oidc v0.0.0-20170119174436-2cc7913f9f6f/go.mod"
	...
	"github.com/digitalocean/go-smbios v0.0.0-20180907143718-390a4f403a8e/go.mod"
	...
	"github.com/dvyukov/go-fuzz v0.0.0-20210914135545-4980593459a1/go.mod"
	...
	"github.com/farjump/go-libudev v0.0.0-20171109190736-8b0739cd6d0b/go.mod"
	...
	"github.com/frankban/quicktest v0.8.0/go.mod"
	"github.com/frankban/quicktest v1.0.0/go.mod"
	"github.com/frankban/quicktest v1.1.0/go.mod"
	"github.com/frankban/quicktest v1.1.1/go.mod"
	"github.com/frankban/quicktest v1.2.2/go.mod"
	...
	"github.com/garyburd/go-oauth v0.0.0-20150329160146-3131beb69b81/go.mod"
	...
	"github.com/go-macaroon-bakery/macaroonpb v1.0.0/go.mod"
	...
	"github.com/google/go-cmp v0.1.0/go.mod"
	"github.com/google/go-cmp v0.2.0/go.mod"
	"github.com/google/go-cmp v0.2.1-0.20190312032427-6f77996f0c42/go.mod"
	...
	"github.com/gorilla/handlers v0.0.0-20170224193955-13d73096a474/go.mod"
	...
	"github.com/gosexy/gettext v0.0.0-20160830220431-74466a0a0c4a/go.mod"
	...
	"github.com/jaypipes/pcidb v0.6.0/go.mod"
	"github.com/jessevdk/go-flags v1.5.0/go.mod"
	"github.com/jkeiser/iter v0.0.0-20200628201005-c8aa0ae784d1/go.mod"
	...
	"github.com/juju/aclstore v0.0.0-20180706073322-7fc1cdaacf01/go.mod"
	"github.com/juju/aclstore/v2 v2.0.0/go.mod"
	...
	"github.com/juju/clock v0.0.0-20180808021310-bab88fc67299/go.mod"
	...
	"github.com/juju/cmd v0.0.0-20180424151504-9ce53c6f9d00/go.mod"
	...
	"github.com/juju/errors v0.0.0-20180726005433-812b06ada177/go.mod"
	"github.com/juju/errors v0.0.0-20180806074554-22422dad46e1/go.mod"
	"github.com/juju/errors v0.0.0-20190207033735-e65537c515d7/go.mod"
	"github.com/juju/errors v0.0.0-20200330140219-3fe23663418f/go.mod"
	"github.com/juju/errors v0.0.0-20210818161939-5560c4c073ff/go.mod"
	"github.com/juju/gnuflag v0.0.0-20171113085948-2ce1bb71843d/go.mod"
	"github.com/juju/go4 v0.0.0-20160222163258-40d72ab9641a/go.mod"
	"github.com/juju/gomaasapi v0.0.0-20200602032615-aa561369c767/go.mod"
	"github.com/juju/httpprof v0.0.0-20141217160036-14bf14c30767/go.mod"
	"github.com/juju/httprequest v1.0.1/go.mod"
	"github.com/juju/loggo v0.0.0-20160818025724-3b7ece48644d/go.mod"
	...
	"github.com/juju/loggo v0.0.0-20190212223446-d976af380377/go.mod"
	...
	"github.com/juju/mgo/v2 v2.0.0-20210414025616-e854c672032f/go.mod"
	"github.com/juju/mgotest v1.0.1/go.mod"
	"github.com/juju/mutex v0.0.0-20171110020013-1fe2a4bf0a3a/go.mod"
	"github.com/juju/names v0.0.0-20160330150533-8a0aa0963bba/go.mod"
	"github.com/juju/persistent-cookiejar v0.0.0-20170428161559-d67418f14c93/go.mod"
	"github.com/juju/persistent-cookiejar v0.0.0-20171026135701-d5e5a8405ef9/go.mod"
	"github.com/juju/postgrestest v1.1.0/go.mod"
	"github.com/juju/postgrestest v1.1.1/go.mod"
	"github.com/juju/qthttptest v0.0.1/go.mod"
	"github.com/juju/qthttptest v0.1.1"
	"github.com/juju/qthttptest v0.1.1/go.mod"
	...
	"github.com/juju/schema v1.0.0/go.mod"
	"github.com/juju/schema v1.0.1-0.20190814234152-1f8aaeef0989/go.mod"
	"github.com/juju/simplekv v0.0.0-20180621131307-362a422e1a65/go.mod"
	"github.com/juju/simplekv v1.0.0/go.mod"
	"github.com/juju/testing v0.0.0-20161031103713-b8689951f6db/go.mod"
	"github.com/juju/testing v0.0.0-20180402130637-44801989f0f7/go.mod"
	"github.com/juju/testing v0.0.0-20180517134105-72703b1e95eb/go.mod"
	...
	"github.com/juju/usso v1.0.1/go.mod"
	"github.com/juju/utils v0.0.0-20161003233226-28c01ec2ad93/go.mod"
	"github.com/juju/utils v0.0.0-20180424094159-2000ea4ff043/go.mod"
	"github.com/juju/utils v0.0.0-20180619112806-c746c6e86f4f/go.mod"
	...
	"github.com/juju/utils v0.0.0-20200604140309-9d78121a29e0/go.mod"
	"github.com/juju/utils/v2 v2.0.0-20200923005554-4646bfea2ef1/go.mod"
	"github.com/juju/version v0.0.0-20160603194958-4ae6172c0062/go.mod"
	...
	"github.com/juju/webbrowser v0.0.0-20160309143629-54b8c57083b4/go.mod"
	"github.com/juju/webbrowser v1.0.0"
	"github.com/juju/webbrowser v1.0.0/go.mod"
	"github.com/julienschmidt/httprouter v0.0.0-20151013225520-77a895ad01eb/go.mod"
	"github.com/julienschmidt/httprouter v1.1.1-0.20151013225520-77a895ad01eb/go.mod"
	"github.com/julienschmidt/httprouter v1.2.0/go.mod"
	"github.com/julienschmidt/httprouter v1.3.0"
	"github.com/julienschmidt/httprouter v1.3.0/go.mod"
	"github.com/k-sone/critbitgo v1.4.0/go.mod"
	...
	"github.com/lxc/lxd v0.0.0-20211014205534-1fe27515c001/go.mod"
	...
	"github.com/mdlayher/netx v0.0.0-20200512211805-669a06fde734/go.mod"
	"github.com/mdlayher/vsock v0.0.0-20210303205602-10d591861736/go.mod"
	"github.com/mgutz/ansi v0.0.0-20170206155736-9520e82c474b/go.mod"
	"github.com/mhilton/openid v0.0.0-20150511103207-7922a4e937d8/go.mod"
	...
	"github.com/mpvl/subtest v0.0.0-20160608141506-f6e4cfd4b9ea/go.mod"
	...
	"github.com/osrg/gobgp v0.0.0-20211001064702-91b91278600d/go.mod"
	...
	"github.com/pquerna/cachecontrol v0.0.0-20160421231612-c97913dcbd76/go.mod"
	...
	"github.com/yohcop/openid-go v1.0.0/go.mod"
	...
	"golang.org/x/crypto v0.0.0-20160922170629-8e06e8ddd962/go.mod"
	...
	"golang.org/x/net v0.0.0-20150829230318-ea47fc708ee3/go.mod"
	"golang.org/x/net v0.0.0-20170915142106-8351a756f30f/go.mod"
	"golang.org/x/net v0.0.0-20180306060152-d25186b37f34/go.mod"
	...
	"golang.org/x/net v0.0.0-20190313082753-5c2c250b6a70/go.mod"
	...
	"golang.org/x/net v0.0.0-20211004195052-b30845b58a23/go.mod"
	"golang.org/x/net v0.0.0-20211014222326-fd004c51d1d6"
	"golang.org/x/net v0.0.0-20211014222326-fd004c51d1d6/go.mod"
	...
	"golang.org/x/tools v0.0.0-20180911133044-677d2ff680c1/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20211001223012-bfb93cce50d9/go.mod"
	...
	"gopkg.in/errgo.v1 v1.0.0-20151007153157-66cb46252b94/go.mod"
	"gopkg.in/errgo.v1 v1.0.0-20161222125816-442357a80af5/go.mod"
	"gopkg.in/errgo.v1 v1.0.0/go.mod"
	"gopkg.in/errgo.v1 v1.0.1"
	"gopkg.in/errgo.v1 v1.0.1/go.mod"
	...
	"gopkg.in/goose.v1 v1.0.0-20161130145116-8f055ce635d6/go.mod"
	"gopkg.in/httprequest.v1 v1.1.1/go.mod"
	"gopkg.in/httprequest.v1 v1.1.2/go.mod"
	"gopkg.in/httprequest.v1 v1.2.0/go.mod"
	"gopkg.in/httprequest.v1 v1.2.1"
	"gopkg.in/httprequest.v1 v1.2.1/go.mod"
	"gopkg.in/inf.v0 v0.9.1/go.mod"
	"gopkg.in/ini.v1 v1.51.0/go.mod"
	"gopkg.in/ini.v1 v1.62.0/go.mod"
	"gopkg.in/ini.v1 v1.63.2/go.mod"
	"gopkg.in/juju/environschema.v1 v1.0.0/go.mod"
	"gopkg.in/juju/names.v2 v2.0.0-20180621093930-fd59336b4621/go.mod"
	"gopkg.in/ldap.v2 v2.5.1/go.mod"
	"gopkg.in/lxc/go-lxc.v2 v2.0.0-20210307013912-d9b9f727ce0f/go.mod"
	"gopkg.in/macaroon-bakery.v2 v2.3.0"
	"gopkg.in/macaroon-bakery.v2 v2.3.0/go.mod"
	...
	"gopkg.in/natefinch/lumberjack.v2 v2.0.0-20170531180850-df99d62fd42d/go.mod"
	"gopkg.in/natefinch/lumberjack.v2 v2.0.0/go.mod"
	"gopkg.in/resty.v1 v1.12.0/go.mod"
	"gopkg.in/retry.v1 v1.0.2/go.mod"
	"gopkg.in/retry.v1 v1.0.3/go.mod"
	...
	"gopkg.in/yaml.v2 v2.0.0-20160301204022-a83829b6f129/go.mod"
	...
	"launchpad.net/lpad v0.0.0-20131113112110-000000000065/go.mod"
...
SRC_URI="https://api.github.com/repos/lxc/distrobuilder/tarball/distrobuilder-2.0 -> distrobuilder-2.0.tar.gz
	${EGO_SUM_SRC_URI}"
