...
EGO_SUM=(
	...
	"github.com/aws/aws-sdk-go v1.44.110/go.mod"
	...
	"github.com/hashicorp/hcp-sdk-go v0.28.0/go.mod"
	...
	"github.com/hashicorp/packer-plugin-alicloud v1.0.5/go.mod"
	"github.com/hashicorp/packer-plugin-amazon v1.1.6"
	"github.com/hashicorp/packer-plugin-amazon v1.1.6/go.mod"
	...
	"github.com/hashicorp/packer-plugin-azure v1.3.1/go.mod"
	...
	"github.com/hashicorp/packer-plugin-googlecompute v1.0.16/go.mod"
	...
	"github.com/hashicorp/packer-plugin-proxmox v1.1.0/go.mod"
	...
	"github.com/hashicorp/packer-plugin-qemu v1.0.8/go.mod"
	...
	"github.com/hashicorp/packer-plugin-sdk v0.3.2/go.mod"
...
SRC_URI="https://api.github.com/repos/hashicorp/packer/tarball/v1.8.5 -> packer-v1.8.5.tar.gz
	${EGO_SUM_SRC_URI}"
