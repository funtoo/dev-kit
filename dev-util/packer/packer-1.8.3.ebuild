...
EGO_SUM=(
	...
	"github.com/!telmate/proxmox-api-go v0.0.0-20220107223401-b9c909d83a3b/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.42.29/go.mod"
	...
	"github.com/digitalocean/packer-plugin-digitalocean v1.0.8/go.mod"
	...
	"github.com/hashicorp/go-getter/gcs/v2 v2.1.0/go.mod"
	...
	"github.com/hashicorp/go-getter/s3/v2 v2.1.0/go.mod"
	...
	"github.com/hashicorp/go-getter/v2 v2.0.2/go.mod"
	"github.com/hashicorp/go-getter/v2 v2.1.0"
	"github.com/hashicorp/go-getter/v2 v2.1.0/go.mod"
	...
	"github.com/hashicorp/hcl/v2 v2.12.0/go.mod"
	"github.com/hashicorp/hcl/v2 v2.13.0"
	"github.com/hashicorp/hcl/v2 v2.13.0/go.mod"
	"github.com/hashicorp/hcp-sdk-go v0.20.1-0.20220726131832-34fbcf69a746"
	"github.com/hashicorp/hcp-sdk-go v0.20.1-0.20220726131832-34fbcf69a746/go.mod"
	...
	"github.com/hashicorp/packer-plugin-alicloud v1.0.2/go.mod"
	"github.com/hashicorp/packer-plugin-amazon v1.1.2"
	"github.com/hashicorp/packer-plugin-amazon v1.1.2/go.mod"
	...
	"github.com/hashicorp/packer-plugin-azure v1.3.0/go.mod"
	...
	"github.com/hashicorp/packer-plugin-cloudstack v1.0.1/go.mod"
	...
	"github.com/hashicorp/packer-plugin-docker v1.0.7/go.mod"
	"github.com/hashicorp/packer-plugin-googlecompute v1.0.14"
	"github.com/hashicorp/packer-plugin-googlecompute v1.0.14/go.mod"
	"github.com/hashicorp/packer-plugin-hcloud v1.0.4"
	"github.com/hashicorp/packer-plugin-hcloud v1.0.4/go.mod"
	...
	"github.com/hashicorp/packer-plugin-oracle v1.0.2/go.mod"
	...
	"github.com/hashicorp/packer-plugin-proxmox v1.0.8/go.mod"
	...
	"github.com/hashicorp/packer-plugin-qemu v1.0.5/go.mod"
	...
	"github.com/hashicorp/packer-plugin-sdk v0.2.12/go.mod"
	"github.com/hashicorp/packer-plugin-sdk v0.2.13/go.mod"
	"github.com/hashicorp/packer-plugin-sdk v0.3.0/go.mod"
	"github.com/hashicorp/packer-plugin-sdk v0.3.1"
	"github.com/hashicorp/packer-plugin-sdk v0.3.1/go.mod"
	"github.com/hashicorp/packer-plugin-tencentcloud v1.0.5"
	"github.com/hashicorp/packer-plugin-tencentcloud v1.0.5/go.mod"
	...
	"github.com/hashicorp/packer-plugin-vsphere v1.0.7/go.mod"
...
SRC_URI="https://api.github.com/repos/hashicorp/packer/tarball/v1.8.3 -> packer-v1.8.3.tar.gz
	${EGO_SUM_SRC_URI}"
