...
EGO_SUM=(
	...
	"github.com/hashicorp/packer-plugin-alicloud v1.0.4/go.mod"
	"github.com/hashicorp/packer-plugin-amazon v1.1.5"
	"github.com/hashicorp/packer-plugin-amazon v1.1.5/go.mod"
	...
	"github.com/hashicorp/packer-plugin-qemu v1.0.6/go.mod"
	...
	"github.com/hashicorp/packer-plugin-vsphere v1.1.0/go.mod"
	...
	"golang.org/x/net v0.0.0-20220920183852-bf014ff85ad5/go.mod"
...
SRC_URI="https://api.github.com/repos/hashicorp/packer/tarball/v1.8.4 -> packer-v1.8.4.tar.gz
	${EGO_SUM_SRC_URI}"
