...
SRC_URI="https://api.github.com/repos/rust-lang/rust-analyzer/tarball/2023-04-04 -> rust-analyzer-20230404.tar.gz
...
src_install() {
	...
	CFG_RELEASE="$RUST_VERSION (2023-04-04-standalone-funtoo)" cargo_src_install --path "./crates/rust-analyzer"
	einstalldocs
}