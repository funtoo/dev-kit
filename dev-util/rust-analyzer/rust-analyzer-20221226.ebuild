...
SRC_URI="https://api.github.com/repos/rust-lang/rust-analyzer/tarball/2022-12-26 -> rust-analyzer-20221226.tar.gz
...
src_install() {
	...
	CFG_RELEASE="$RUST_VERSION (2022-12-26-standalone-funtoo)" cargo_src_install --path "./crates/rust-analyzer"
	einstalldocs
}