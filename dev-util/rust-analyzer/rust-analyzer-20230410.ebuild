...
SRC_URI="https://api.github.com/repos/rust-lang/rust-analyzer/tarball/2023-04-10 -> rust-analyzer-20230410.tar.gz
...
src_install() {
	...
	CFG_RELEASE="$RUST_VERSION (2023-04-10-standalone-funtoo)" cargo_src_install --path "./crates/rust-analyzer"
	einstalldocs
}