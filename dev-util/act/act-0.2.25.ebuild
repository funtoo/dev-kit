...
EGO_SUM=(
	...
	"github.com/!akihiro!suda/containerd-fuse-overlayfs v1.0.0/go.mod"
	"github.com/!alec!aivazis/survey/v2 v2.3.2"
	"github.com/!alec!aivazis/survey/v2 v2.3.2/go.mod"
	...
	"github.com/!google!cloud!platform/cloudsql-proxy v0.0.0-20191009163259-e802c2cb94ae/go.mod"
	"github.com/!google!cloud!platform/k8s-cloud-provider v0.0.0-20190822182118-27a4ced34534/go.mod"
	...
	"github.com/!open!pee!dee!p/depguard v1.0.1/go.mod"
	"github.com/!proton!mail/go-crypto v0.0.0-20210428141323-04723f9f07d7/go.mod"
	"github.com/!proton!mail/go-crypto v0.0.0-20210920160938-87db9fbc61c7"
	"github.com/!proton!mail/go-crypto v0.0.0-20210920160938-87db9fbc61c7/go.mod"
	...
	"github.com/containerd/containerd v1.5.3/go.mod"
	...
	"github.com/go-ini/ini v1.64.0/go.mod"
	...
	"github.com/moby/buildkit v0.9.2/go.mod"
	...
	"github.com/tonistiigi/go-actions-cache v0.0.0-20211002214948-4d48f2ff622a/go.mod"
	...
	"go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.21.0/go.mod"
	"go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace v0.21.0/go.mod"
	"go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.21.0/go.mod"
	"go.opentelemetry.io/otel v1.0.0-!r!c1/go.mod"
	"go.opentelemetry.io/otel/exporters/jaeger v1.0.0-!r!c1/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.0.0-!r!c1/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.0.0-!r!c1/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v1.0.0-!r!c1/go.mod"
	...
	"go.opentelemetry.io/otel/sdk v1.0.0-!r!c1/go.mod"
...
SRC_URI="https://api.github.com/repos/nektos/act/tarball/v0.2.25 -> act-0.2.25.tar.gz
	${EGO_SUM_SRC_URI}"
