...
EGO_SUM=(
	...
	"github.com/rhysd/actionlint v1.6.13/go.mod"
	...
	"golang.org/x/sys v0.0.0-20220513210249-45d2b4557a2a/go.mod"
...
SRC_URI="https://api.github.com/repos/nektos/act/tarball/v0.2.28 -> act-0.2.28.tar.gz
	${EGO_SUM_SRC_URI}"
