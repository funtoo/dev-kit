...
async def generate(hub, **pkginfo):
	...
	version_headers = (
		version_pattern.match(x.get("data-text")) for x in release_notes_soup.find_all("h2", attrs={"data-text": True})
	)
		...
		**pkginfo,
		...
		artifacts=[
			hub.pkgtools.ebuild.Artifact(
				url=f"https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/{pkginfo['name']}-{version}-linux-x86_64.tar.gz"
			)
		],
	)
	ebuild.push()
