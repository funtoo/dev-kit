...
SRC_URI="amd64? (
  https://github.com/WebAssembly/binaryen/releases/download/version_117/binaryen-version_117-x86_64-linux.tar.gz -> binaryen-version_117-x86_64-linux.tar.gz
)
arm64? (
  https://github.com/WebAssembly/binaryen/releases/download/version_117/binaryen-version_117-aarch64-linux.tar.gz -> binaryen-version_117-aarch64-linux.tar.gz
)
"
