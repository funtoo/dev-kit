...
SRC_URI="amd64? (
  https://github.com/WebAssembly/binaryen/releases/download/version_121/binaryen-version_121-x86_64-linux.tar.gz -> binaryen-version_121-x86_64-linux.tar.gz
)
arm64? (
  https://github.com/WebAssembly/binaryen/releases/download/version_121/binaryen-version_121-aarch64-linux.tar.gz -> binaryen-version_121-aarch64-linux.tar.gz
)
"
